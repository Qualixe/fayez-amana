    ...
    <header className="relative flex min-h-[92svh] items-end overflow-hidden border-b border-steel">
      ...
      <div className="relative mx-auto w-full max-w-full px-6 pb-16 pt-32 sm:px-8 sm:pb-20 lg:px-12">
        <div className="flex flex-col">
          ...
          >
            BRU CO. (Building Reference United) is a Jeddah-based construction
            company and general contractor delivering integrated construction
            under one roof: structural, architectural, electromechanical and
            interior works. 25+ years, 300+ completed projects, ISO-certified
            and classified by the Saudi Contractors Authority, serving Jeddah,
            Makkah and the wider Kingdom of Saudi Arabia.
          </Reveal>
